...
class LSTM_SA_Trainer():
    ...
    def _save_current_model(self, sess, x, y, p):
        ...
        save_img_prediction(x, y, p, self._model_path, sess.run(self._global_step))
...
class LSTM_SA_Tester():
    ...
    def test(self, batch_size=1, save_validate_image=False):
        ...
        sio.savemat(path, {"lstm_sa_down_normal_load_batch":_runtime_load_batch,
                            "lstm_sa_down_normal_feedforward_batch":_runtime_feedforward_batch,
                            "lstm_sa_down_normal_save_batch":_runtime_save_batch})
...
class LSTM_SA_Tester_MidSeq():
    ...
    def test(self, save_validate_image=False):
        ...
        path = self._output_path + "runtime.mat"
        sio.savemat(path, {"lstm_sa_down_midseq_load_batch":_runtime_load_batch,
                            "lstm_sa_down_midseq_feedforward_batch":_runtime_feedforward_batch,
                            "lstm_sa_down_midseq_save_batch":_runtime_save_batch})
